...
[Daily Rides vs Max Wind Speed](img/Daily_Rides_vs_Maximum_Wind_Speed.png) 

>This scatter plot illustrates a negative correlation between the maximum wind speed and the number of daily rides, showing that higher wind speeds generally tend to decrease daily ride counts.

##

![Daily Rides vs. Daily Average Temperature](img/Daily_Rides_and_Daily_Average_Temperature.png) 

>This time-series chart displays the parallel trends between daily rides and daily average temperature over the course of the year 2025, highlighting how ride volume tends to fluctuate alongside seasonal temperature changes.
